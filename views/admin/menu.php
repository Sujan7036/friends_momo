...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    switch ($action) {
        ...
        case 'update_item':
            ...
            $imageUrl = $_POST['existing_image'] ?? null; // Keep existing image if no new one
            if (isset($_FILES['image']) && $_FILES['image']['error'] === UPLOAD_ERR_OK) {
                $newImageUrl = handleImageUpload($_FILES['image']);
                if ($newImageUrl) {
                    // Delete old image if it exists and is not a default image
                    if ($imageUrl && strpos($imageUrl, 'uploads/') !== false) {
                        $oldImagePath = dirname(__DIR__, 2) . '/assets/' . $imageUrl;
...
function handleImageUpload($file) {
    $uploadDir = dirname(__DIR__, 2) . '/assets/uploads/menu/';
...
$menuItems = $menuItemModel->getAllForAdmin();
...
<body>
                            ...
                            <tr>
                                <td>
                                    <div class="item-image">
                                        ...
                                        <?php else: ?>
                                            <div style="width: 60px; height: 60px; background-color: #f0f0f0; border-radius: 8px; display: flex; align-items: center; justify-content: center; color: #999;">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group" style="grid-column: 1 / -1;">
                        ...
                        <div class="image-upload-container">
                            <input type="file" name="image" id="image" accept="image/*" onchange="previewImage(this, 'imagePreview')">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group" style="grid-column: 1 / -1;">
                        ...
                        <div class="image-upload-container">
                            <input type="file" name="image" id="edit_image" accept="image/*" onchange="previewImage(this, 'editImagePreview')">
                        ...
                        <small class="form-text">Leave empty to keep current image. Accepted formats: JPG, PNG, GIF, WEBP (Max 5MB)</small>
                    </div>
    ...
    function editItem(item) {
        ...
        document.getElementById('edit_preparation_time').value = item.prep_time || 15;
        ...
        if (item.image_url) {
            editPreview.innerHTML = `<img src="<?= ASSETS_URL ?>/${item.image_url}" alt="${item.name}" style="width: 100%; height: 200px; object-fit: cover; border-radius: 8px;">`;
        } else {
